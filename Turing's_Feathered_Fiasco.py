...
class Pipe:
    ...
    def __init__(self,x,has_coin=False):
        self.x = x
        self.has_coin = has_coin
        self.height = 0
        self.gap = 160
        self.coin_hole = random.randint(0, 1) 
        self.top = 0
        self.bottom = 0
        self.middle_up = 0
        self.middle_down = 0
    ...
    def collide(self,bird):
        ...
        if b_point or t_point or mu_point or md_point:
            return True
        return False
    def collide_coin(self,bird):
        if(self.r=='up'):
            if(bird.y>=(self.middle_up - 100)):
                return True
        elif(self.r=='bottom'):
            if(bird.y<=(self.bottom + self.middle_down - 60)//2):
                return True
        return False
...
def Export(gen):
    global SCORE
    if SCORE > 5 :#Whenever you want to save the bird.
